...
//             Text(
//               '$_counter',
//               style: Theme.of(context).textTheme.headlineLarge,  // Updated here
//             ),
//           ],
//         ),
//       ),
...
import 'package:flutter/material.dart';
import 'package:hello_world/basic_widgets/button_widget.dart';
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ElevatedButton(
              child: const Text('Show Button Widget'),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const MyButtonWidget(),
                  ),
                );
              },
            ),
            ...
            ElevatedButton(
              child: const Text('Show Alert Widget'),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
            ...
            const SizedBox(height: 10),
            ElevatedButton(
              child: const Text('Show FAB Widget'),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
            ...
            const SizedBox(height: 10),
            ElevatedButton(
              child: const Text('Show Image Widget'),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const MyImageWidget(),
                  ),
                );
              },
            ),
            const SizedBox(height: 10),
            ElevatedButton(
              child: const Text('Show Text Widget'),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
